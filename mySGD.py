...
def SGD(gradient, A, b, init, learn_rate, n_iter, batch_size = 1, random_state = None, tolerance = 1e-06, dtype = "float64"):
    """
...
r = SGD(LS_Gradient, A, b, x0, 0.001, 1e4, batch_size=20, tolerance=1e-06)
